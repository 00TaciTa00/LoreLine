...
<table>
  <tr>
    <th align="left">작중 시각</th>
    <th>에리크토니우스</th><th>어느 어부</th><th>베르크</th><th>린다</th>
  </tr>
  <tr>
    <td align="left">고대 :<br>종말 직후</td>
    <td>기억을 남기다</td><td></td><td></td><td></td>
  </tr>
  <tr>
    <td align="left">제5 성력 :<br>모험가, 말년</td>
    <td></td><td>폐허가 더 폐허가 되는 날</td><td></td><td></td>
  </tr>
  <tr>
    <td align="left">제6 성력 :<br>린다, 40세</td>
    <td></td><td></td>
    <td colspan="2">기어코, 그 날</td>
  </tr>
</table>

- 한 사건에 두 인물이 얽히면 **카드 한 장**이 두 열을 가로지른다
  (위 표의 `colspan`이 그 모양이다)
- 인물별 격자에는 **첫 등장부터 마지막 등장까지** 잇는 세로 흐름선이 함께 그려진다
